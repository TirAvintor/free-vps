...
- Copy, modify, merge, publish, distribute, sublicense, or sell copies of this project.
- Create derivative works based on this project.

This project is provided "as is" without warranties or guarantees.  
The copyright holder (TirAvintor) shall not be liable for any claims, damages, or other liabilities arising from the use or inability to use this project.
